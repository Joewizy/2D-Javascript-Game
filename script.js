...
const soundManager = {
    sounds: {
        roll: new Audio('../sounds/hit.mp3'),
        coin: new Audio('../sounds/coin.mp3'),
        hit: new Audio('../sounds/death.mp3'),
...
class Enemy {
    constructor(index) {
        ...
        this.x = canvas.width + (this.index * this.enemySpacing);
    ...
    update() {
        if (this.state === 'normal'){
            ...
            if (this.x + this.width < 0) {
                ...
                if (rightmostX > 0) {
                    let minSpacing = canvas.width * 1.5; 
                    let randomVariance = Math.random() * (canvas.width * 0.8);
                    this.x = rightmostX + minSpacing + randomVariance;
                } else {
                    this.x = canvas.width + Math.random() * 1000 + 1000;
                }
                this.y = Math.random() * (300 - 120) + 120;
            }
...
class Ghost {
    constructor(index){
        ...
        this.x = canvas.width + (index * baseSpacing) + randomSpacing; 
        this.y = 510;
        ...
        if (this.state === 'normal') {
            ...
            if (this.x + this.width < 0){
                ...
                if (rightmostX > 0) {
                    ...
                    this.x = canvas.width + Math.random() * 800 + 800;
                }
            }
        } else if (this.state === 'disappear') {
            this.disappearFrame++;
...
class Coin {
    ...
    update() {
        ...
        if (this.x + this.radius * 2 < 0) {
            this.x = canvas.width + Math.random() * (600 - 200) + 200;
            this.y = Math.random() * (480 - 50) + 50;
        }
    }
    draw() {
...
function animate() {
    ...
    while (enemiesArray.length < maxEnemies) {
        ...
        let newX = rightmostX > 0 ? 
            ...
            canvas.width + Math.random() * 1000 + 1000;
